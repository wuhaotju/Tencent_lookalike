...
path = './data/'
# 将缺失严重的都删除了
one_hot_feature = ['LBS', 'age', 'carrier', 'consumptionAbility', 'education', 'gender', 'advertiserId', 'campaignId',
...
train = pd.read_csv(path + 'on_train.csv')  # 45539700
print("train length", len(train))
test = pd.read_csv(path + 'on_test.csv')    # 23456377
